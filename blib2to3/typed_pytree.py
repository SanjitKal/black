...
from typing import Any, Callable, Dict, Iterator, List, Optional, Text, Tuple, TypeVar, Union, Set, Iterable
...
_type_reprs = {} # type: Dict[int, Union[Text, int]]
...
class Base(object):
    ...
    children: List[_NL] = []  # Tuple of subnodes
    ...
    def get_suffix(self) -> Text:
        ...
        """
        next_sib = self.next_sibling #type: Optional[_NL]
        if next_sib is None:
            return ""
        prefix = next_sib.prefix #type: Text
        return prefix
...
class Node(Base):
    ...
    def __init__(self,type: int, children: List[_NL],
    ...
    def invalidate_sibling_maps(self) -> None:
        self.prev_sibling_map = None # type: Optional[Dict[int, Optional[_NL]]]
        self.next_sibling_map = None # type: Optional[Dict[int, Optional[_NL]]]

    def update_sibling_maps(self) -> None:
        _prev = {} # type: Dict[int, Optional[_NL]]
        _next = {} # type: Dict[int, Optional[_NL]]
        self.prev_sibling_map = _prev
        self.next_sibling_map = _next
        previous = None # Optional[_NL]
...
class BasePattern(object):
    ...
    def match(self, node: _NL, results: Optional[_Results] = None) -> bool:
        """
    ...
    def match_seq(self, nodes: List[_NL], results: Optional[_Results] = None) -> bool:
        """
...
class LeafPattern(BasePattern):
    ...
    def _submatch(self, node, results=None) -> bool:
        ...
        """
        res = self.content == node.value #type: bool
        return res
...
class NegatedPattern(BasePattern):
    ...
    def __init__(self, content: Optional[Text] = None) -> None:
        """
        Initializer.
